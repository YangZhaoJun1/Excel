...
<div style="height: 480px;">
	<table class="easyui-datagrid" id="dataGrid"
		data-options="fit:false,idField:'id',loadMsg:'正在加载…',pagination:true,title:'车辆处罚记录',
			url:'${ctx}/punish/queryPunish.do',toolbar:'#mainProToolbar',
		...
		<thead>
			<tr> 
				...
				<th data-options="field:'punishatDe',align:'center'">处罚日期、时间</th>
				<th data-options="field:'punishPlace',align:'center'">处罚地点</th>
				<th data-options="field:'punishCause',align:'center'">处罚原因</th>
				<th data-options="field:'PenaltyValue',align:'center'">处罚数值</th>
				<th data-options="field:'driver',align:'center'" >驾驶员</th>
				<th data-options="field:'results',align:'center'">后续结果</th>
		</thead>
	</table>
</div>
